...
# -*- coding: utf-8 -*-
"""
Created on Sat Jun  7 22:13:36 2025

Create a graph showing the crosscorrelation between model responses for 10 sets of sentences and model with lower gain
Figs. 6 and 7 in the paper
...
#%% plot 5% quantile simulated results for model with lower gain
...
plt.savefig('Figures/rconvG9q.png', format='png',dpi=600)



#%%  plot the mean values, model with lower gain
...
plt.savefig('Figures/rconvG9m.png', format='png')
