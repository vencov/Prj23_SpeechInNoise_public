...
for i in range(10):
    ax[0,0].plot(L1,xc1q[:,i], label=str(i)), ax[0,0].set_ylim((0,0.49))
    ax[0,1].plot(L,xc2q[:,i], label=str(i)), ax[0,1].set_ylim((0,0.49))
    ax[0,2].plot(L,xc3q[:,i], label=str(i)), ax[0,2].set_ylim((0,0.49))
    ax[0,3].plot(L,xc4q[:,i], label=str(i)), ax[0,3].set_ylim((0,0.49))
    ax[0,4].plot(L,xc5q[:,i], label=str(i)), ax[0,4].set_ylim((0,0.49))
    ax[1,0].plot(L,xc6q[:,i], label=str(i)), ax[1,0].set_ylim((0,0.49))
    ax[1,1].plot(L,xc7q[:,i], label=str(i)), ax[1,1].set_ylim((0,0.49))
    ax[1,2].plot(L,xc8q[:,i], label=str(i)), ax[1,2].set_ylim((0,0.49))
    ax[1,3].plot(L,xc9q[:,i], label=str(i)), ax[1,3].set_ylim((0,0.49))
    ax[1,4].plot(L,xc10q[:,i], label=str(i)), ax[1,4].set_ylim((0,0.49))

plt.gcf().text(0.5, 0.9, 'Lower gain, 0.05 quantile', fontsize=8, fontweight='bold',ha='center')
...
plt.savefig('Figures/rconvG9q.eps', format='eps')
...
plt.gcf().text(0.5, 0.9, 'Lower gain, mean', fontsize=8, fontweight='bold',ha='center')
...
plt.savefig('Figures/rconvG9m.eps', format='eps')
